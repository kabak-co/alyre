  ...
  return book && !isLoading ? (
    <div className="w-full">
      <div className="flex w-full m-5">
        ...
        <BookCover list={false} id={book._id} imageUrl={book.imageUrl} imageWidth="w-full" imageHeigth="600px" />
      ...
      <div>
        ...
        <div className="flex">
          {recommendedBooks.map((book, index) => (
            <BookCover list key={index} id={index.toString()} imageUrl={book.imageUrl} imageWidth="full" imageHeigth="300px" />
          ))}
        </div>
